<%@ page language="java" import="java.util.*"  errorPage="Error/error.jsp"%>
        ...
        $(function () {
            $('#ChinaMap').SVGMap({
                ...
                clickCallback: function (stateData, obj) {
                	  alert(obj.name);
                	window.location.href="../SearchHouse?action=1&address="+obj.name+"&currentpage=1&question=000";
                 // alert("obj.name");
...
<body>
    ...
    <div class="wrap">
        <div style="padding-top:60px;font-family:'幼圆';font-size:32px;color:#FFF;height:50px;">请选择您想要居住的省份</div>
